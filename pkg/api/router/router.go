...
func Router(ctx context.Context, services *services.Services) (http.Handler, error) {
	...
	mcpGateway := mcpgateway.NewHandler(services.MCPSessionManager, services.PersistentTokenServer)
	...
	// Obot OAuth
	oauth.SetupHandlers(oauthChecker, services.MCPOAuthTokenStorage, services.PersistentTokenServer, services.OAuthServerConfig, services.ServerURL, services.GatewayServer.AuthCompleteURL(), services.MCPOAuthClientSecretExpiration, mux)
